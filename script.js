...
function solution(x,y,z, color=0x0000ff) {
	...
	this.points = [];
	this.color = color
	this.headgeometry = new THREE.SphereGeometry(0.5,24,24);
	this.headmaterial = new THREE.MeshLambertMaterial({ color: this.color});
...
solutions.push(new solution(0,1,50, 0xff0000))
solutions.push(new solution(0,1,50.00001,0xff0000))
solutions.push(new solution(0,1,50.00002,0xff0000))
solutions.push(new solution(0,1,50.00003, 0xff0000))
solutions.push(new solution(0,1,50.00004,0xff00000))
solutions.push(new solution(0,1,50.00005,0xff0000))
let scrolling = false;
